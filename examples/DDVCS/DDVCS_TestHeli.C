...
void DDVCS_TestHeli(){
  ...
  //create reaction dataframe
   rad::config::HepMCElectro hepmc{"hepmc3_tree", "ddvcs_snap.root" };
  ...
  hepmc.Define("p_helicity","1");
  //hepmc.Define("GammaPol_circ","sqrt(1-GammaPol*GammaPol)*e_helicity");
  ...
  // hepmc.BookHepMC3Snapshot("ddvcs_snap.root");
