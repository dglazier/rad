...
void eslight(const std::string infile="/w/work5/home/garyp/JPsi_rootfiles/eslight_jpsi_18x275_1M.root", const std::string outfile="eslight_jpsi.root"){
  ...
  hepmc.setParticleIndex("pprime",6);
  ...
  hepmc.setParticleIndex("ele",5);
  hepmc.setParticleIndex("pos",4);
  ...
  histo.Create<TH1D,double>({"ttop","t(g,gprime) [GeV^{2}]",100,0,2.0},{"t_top"});
  ...
  gSystem->Exec("pdfunite temp*.pdf eslight_histos.pdf");
